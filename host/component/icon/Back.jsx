...
export default function BackIcon({ colorClassName = 'fill-gray-800 dark:fill-gray-400', }) {
    return (<svg className={colorClassName} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0 0 45.58 45.58" xmlSpace="preserve">
      <g>
