...
export default function MenuIcon({ colorClassName = 'color-gray-800 dark:color-gray-400', }) {
    return (<svg className={colorClassName} width="100%" height="100%" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
