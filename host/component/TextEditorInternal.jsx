...
export const TEXT_EDITOR_LANGUAGE = {
    wast: wastLanguage,
...
export default function TextEditor({ editorRef, value, language, onChange, height, theme, className, readOnly, style, }) {
    ...
    return (<CodeMirror className={cx('min-h-0 [&_div]:leading-content', className)} role="code" style={style} value={value} height={height} readOnly={readOnly} onCreateEditor={handleCreateEditor} basicSetup={{
            lineNumbers: false,
            defaultKeymap: false,
            searchKeymap: false,
            historyKeymap: false,
            ...
            indentOnInput: true,
        }} theme={theme && TEXT_EDITOR_THEME[theme]({ theme: themeMode })} extensions={extensions} onChange={onChange}/>);
}
//# sourceMappingURL=TextEditorInternal.jsx.map