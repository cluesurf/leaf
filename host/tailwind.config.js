    ...
    theme: {
        extend: {
            ...
            maxHeight: {
                ...
                'select-content': 'var(--radix-select-content-available-height)',
            },
            maxWidth: {
                224: '224px',
                248: '248px',
            ...
            boxShadow: {
                ...
                medium: 'rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px',
                'medium-green': 'rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px',
                ...
                '3xl-dark': 'rgba(50, 50, 93, 0.25) 0px 13px 27px -5px, rgba(0, 0, 0, 0.3) 0px 8px 16px -8px, rgba(50, 50, 93, 0.25) 0px -13px 27px -5px, rgba(0, 0, 0, 0.3) 0px -8px 16px -8px',
